...
git config --global user.email joao.cunha@webcomum.com
...
curl https://raw.githubusercontent.com/crawlingcity/macsetup/master/c0defire3.zsh-theme > brad-muse.zsh-theme
